...
disc_per=st.slider('Select Number of Medicines',0,100)
...
for i in range(med_count):
    ...
    med_sp=med_master['Cost Price'][med_master[med_master['Name']=='Dolo 500'].index.values[0]]
    self_receipt.loc[len(self_receipt)] = [med_name,med_sp,med_qty,med_qty*med_sp,med_qty*med_sp*disc_per/100]
